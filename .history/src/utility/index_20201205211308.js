...
import {REGEX_LATITUDE} from "@constants/map";
import images from '@resources/icons';
import moment from "moment";
import {user} from "@feature/profile/modules/actions";
...
export const datetimeLocalToUtc = (datetime, tz:number) => {
  return moment(datetime).utc().format('YYYY-MM-DD HH:mm:ss');
}

export const datetimeUtcToLocal = (datetime, tz: number) => {
